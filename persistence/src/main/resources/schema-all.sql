...
-- +++++++++++++++ZONES OBJECTS++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
-- GEO_ZONES (GLOBAL)---------------------------------------------
CREATE SEQUENCE zoo.geo_zone_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.GEO_ZONES (
  ID   BIGINT PRIMARY KEY DEFAULT nextval('zoo.geo_zone_id_seq'),
...
CREATE SEQUENCE zoo.zoo_zone_id_seq START WITH 1;
CREATE TABLE ZOO.ZOO_ZONES (
  ID             BIGINT PRIMARY KEY DEFAULT nextval('zoo.zoo_zone_id_seq'),
...
CREATE SEQUENCE zoo.class_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.CLASSES (
  ID   BIGINT PRIMARY KEY DEFAULT nextval('zoo.class_id_seq'),
  NAME VARCHAR(50) NOT NULL
);
...
CREATE SEQUENCE zoo.family_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.FAMILIES (
  ID       BIGINT PRIMARY KEY DEFAULT nextval('zoo.family_id_seq'),
  NAME     VARCHAR(50) NOT NULL,
...
CREATE SEQUENCE zoo.species_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.SPECIES (
  ID              BIGINT PRIMARY KEY DEFAULT nextval('zoo.species_id_seq'),
...
COMMENT ON COLUMN ZOO.SPECIES.ANIMALS_PER_HOUSE IS 'This required value specifies the "density" of this individual';
COMMENT ON COLUMN ZOO.SPECIES.TEMPERATURE_MIN IS 'MINIMUM RECOMMENDED TEMPERATURE FOR LIVING';
COMMENT ON COLUMN ZOO.SPECIES.TEMPERATURE_MAX IS 'MAXIMUM RECOMMENDED TEMPERATURE FOR LIVING';
--END OF SPECIES ----------------------------------------------------------------------------
...
CREATE SEQUENCE zoo.house_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.HOUSES (
  ID           BIGINT PRIMARY KEY   DEFAULT nextval('zoo.house_id_seq'),
...
CREATE SEQUENCE zoo.warehouse_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.WAREHOUSES (
  ID           BIGINT PRIMARY KEY                             DEFAULT nextval('zoo.warehouse_id_seq'),
...
CREATE SEQUENCE zoo.animal_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.ANIMALS (
  ID                BIGINT PRIMARY KEY DEFAULT nextval('zoo.animal_id_seq'),
...
CREATE SEQUENCE zoo.employee_role_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.EMPLOYEE_ROLES (
  ID    BIGINT PRIMARY KEY DEFAULT nextval('zoo.employee_role_id_seq'),
...
CREATE SEQUENCE zoo.employee_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.EMPLOYEES (
  ID         BIGINT PRIMARY KEY DEFAULT nextval('zoo.employee_id_seq'),
...
CREATE SEQUENCE zoo.task_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS ZOO.TASKS (
  ID                     BIGINT PRIMARY KEY DEFAULT nextval('zoo.task_id_seq'),
